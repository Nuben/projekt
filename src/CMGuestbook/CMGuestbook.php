...
class CMGuestbook extends CObject implements IHasSQL {
  ...
  public function Init() {
    try {
      ...
      $this->session->AddMessage('notice', 'Försöket att skapa en tabell lyckades. Om en tabell redan fanns gjordes dock inget');
    } catch(Exception$e) {
  ...
  public function Add($entry) {
    ...
    $this->session->AddMessage('success', 'Ditt meddelande postades');
  ...
  public function DeleteAll() {
    ...
    $this->session->AddMessage('info', 'Alla meddelanden är nu borttagna från databasen');
  }
